...
"} catch(e){ var A=thisComp.layer('"+escName(originName)+"'); var B=thisComp.layer('"+escName(layerBName)+"'); var p1=thisLayer.fromComp(A.toComp(A.anchorPoint)); var p2=thisLayer.fromComp(B.toComp(B.anchorPoint)); createPath([p1,p2],[[0,0],[0,0]],[[0,0],[0,0]],false); }\n"
  );
}
